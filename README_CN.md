...
- 删除了对 `xorm.io/core` 的依赖。大部分代码迁移到了 `github.com/misu99/xorm/core`, `github.com/misu99/xorm/names`, `github.com/misu99/xorm/schemas` 等等几个包中.
...
* [Godoc代码文档](http://pkg.go.dev/github.com/misu99/xorm)
